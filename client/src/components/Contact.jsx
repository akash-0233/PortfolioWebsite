...
function Contact() {
  ...
  const handleSubmit = (event) => {
    ...
    if (!formData.email && !formData.number) {
      setOverlayMessage("Please provide either an email or a mobile number.");
    ...
    <section id='contact' className="contact-form">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input placeholder='email@gmail.com' type="email" name="email" id='email'  value={formData.email} onChange={handeChange} />
        </div>
        <div>
          <label htmlFor='number'>Mobile Number</label> 
          <input placeholder='mobile number' type="tel" name="number" id='number' value={formData.number} onChange={handeChange} />
        </div>
        <div>
